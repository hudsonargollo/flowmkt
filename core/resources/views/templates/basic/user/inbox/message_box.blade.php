<div class="chat-box">
    ...
    <div class="chat-box__header position-relative">
        ...
        <div class="d-flex align-items-center justify-content-center gap-2">
            <button type="button" class="template_button" title="@lang('Send message template')">
                <i class="las la-envelope-square"></i>
            </button>
            <button type="button" class="clear_button confirmationBtn" data-action="" data-question="@lang('Are you sure to clear this conversation?')" title="@lang('Clear chat')">
