                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 'success') {
                            ...
                            console.log(response.data.clearChatRoute);
                            
                            $(document).find('.clear_button').attr('data-action', response.data.clearChatRoute); 
...
@push('style')
    <style>
        ...
        .woo-product-list {
            position: relative; /* This is important so the overlay positions correctly */
            min-height: 200px; /* Or any height so overlay has area to cover */
        }
