                        ...
                        <div class="form-group mb-3">
                            <div class="alert alert--warning flex-column  border border-1 border--warning">
                                <div class="alert__content">
                                    ...
                                    <p class="mb-2">
                                        <i class="las la-info-circle"></i> @lang('If you are using the Meta test application, you must add the recipient phone number to the Meta Dashboard as a test phone number. Messages will not be delivered in test mode unless the number is added.')
                                    </p>
                                    <p class="mb-2">
                                        <i class="las la-info-circle"></i> @lang('If the test phone number has already been added but you are not receiving messages, try sending a message from your WhatsApp test number to the Meta app phone number first. Due to Meta spam protection, messages may sometimes be blocked initially.')
                                    </p>
                                    <p class="mb-2">
                                        <i class="las la-info-circle"></i> @lang('Please note that these limitations apply only to test mode. In live/production mode, messages can be sent to any valid phone number without these restrictions.')
                                    </p>
                                </div>
                            </div>
                        </div>
